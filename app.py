# -*- coding: utf-8 -*-
"""Despliegue de videojuegos con streamlit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/185zLG0gwRRZdkbaMxRDLQ63bBPKMKGA2
...
#Preparación de los datos. Crear dummies
...
#Se adicionan las columnas faltantes. Reindex compara si hay alguna variable que sobra, la quita y si falta, la crea y la llena con ceros
...
#Hacemos la predicción con el Tree. CON MODELO.PREDICT
...
#PREDICCIONES FINALES. PARA QUE SE VEA LA TABAL DE DATA
data

#Advertencia de error del modelo
